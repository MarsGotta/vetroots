...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'About page \u2014 brand story, Lu bio';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    luBio: Schema.Attribute.Blocks;
    luPhoto: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content category for organizing fichas, posters, and videos';
  ...
  attributes: {
    ...
    posters: Schema.Attribute.Relation<'oneToMany', 'api::poster.poster'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFichaFicha extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    level: Schema.Attribute.Enumeration<['basico', 'intermedio', 'avanzado']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featuredFichas: Schema.Attribute.Relation<'oneToMany', 'api::ficha.ficha'>;
    featuredPosters: Schema.Attribute.Relation<
      'oneToMany',
      'api::poster.poster'
    >;
...
export interface ApiSpeciesSpecies extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fichas: Schema.Attribute.Relation<'manyToMany', 'api::ficha.ficha'>;
    icon: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    posters: Schema.Attribute.Relation<'manyToMany', 'api::poster.poster'>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
